...
const MyInterestItem: React.FC<MyInterestItemProps> = ({ data, onClick }) => {
  const { interestIdx, interestName } = data;

  return (
    <div className="w-full h-[40px] bg-lightgrayColor rounded-[8px] p-[10px] mb-[8px] flex justify-between items-center">
